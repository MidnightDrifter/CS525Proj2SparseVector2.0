...
void test13( void )
{
    ...
    printf_elements( pE1,"%4d",10 );
    printf( "\n" );
    for( i=0; i<20; ++i ) insert_element( &pE2,20-i,i );
    printf_elements( pE2,"%4d",10 );
    printf( "\n" );
    for( i=0; i<10; ++i ) {
        if( i%2 ) insert_element( &pE3,i,i );
...
void test23( void )
{
    RowNode * pR1=0, *pR2=0, *pR3, *pR4, *pR5;
    int i;
    printf( "\n===== MULTIPLICATION =======================\n" );
...
void test25( void ); // all vector tests
void test26( void ); // all matrix tests
